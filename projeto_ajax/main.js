/*Arquivos atualizados em JSON da API The SportsDB*/
const teams = [
    {
        "idTeam": "133772",
        "idSoccerXML": "188",
...
/*Pegando os dados necessários do arquivo JSON e passando para HTML*/
document.getElementById("app").innerHTML = `
${teams.map(function (ajax) {
    return `
    <div class="ajax">
        <img class="ajax-logo" src="${ajax.strTeamBadge}" width="400px" height="400px"></img> 
        <h2 class="team-name">${ajax.strTeam} (${ajax.strAlternate})</h2>
